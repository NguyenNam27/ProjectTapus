    ...
    <div class="page" id="top">
        ...
        <section class="page-section" id="about">
            <div class="container relative">
                <div class="sec2-hang">
                    <img src="./images/hdsd-1.png" alt="" class="hdsd-img">
                    <div class="sec2-text">
                        <h1>CHỌN MẪU THẺ</h1>
                        <h2>Chọn mẫu thẻ ưng ý và thiết lập thông tin mà bạn mong muốn hiển thị. Sau khi hoàn thiện các
                            bước theo hướng dẫn, chúng tôi sẽ tiến hành thiết kế và phát hành thẻ. Đối với những mẫu thẻ
                            tùy chỉnh cá nhân, vui lòng liên hệ với TAPUS để được tư vấn.</h2>
                    </div>

                </div>
                <div class="sec2-hang">
                    <img src="./images/hdsd-2.png" alt="" class="hdsd-img">
                    <div class="sec2-text">
                        <h1>CHỈNH SỬA TRANG CÁ NHÂN</h1>
                        <h2>Sau khi thanh toán, bạn có thể đăng nhập và bắt đầu tùy chỉnh thông tin trên trang cá nhân
                            của mình. Bạn có thể chọn những bố cục có sẵn của Tapus hoặc tự do bố trí trang của mình
                        </h2>
                    </div>

                </div>
                <div class="sec2-hang">
                    <img src="./images/hdsd-3.png" alt="" class="hdsd-img">
                    <div class="sec2-text">
                        <h1>SỬ DỤNG THẺ TAPUS</h1>
                        <h2>Sau khi sở hữu thẻ, bạn có thể sử dụng thẻ trên mọi thiết bị di động trên các nền tảng:
                            Android, iOS, Microsoft có hỗ trợ công nghệ NFT. Tap thẻ của bạn vào thiết bị bạn muốn chia
                            sẻ thông tin.</h2>
                        <h1>THÀNH CÔNG</h1>
                        <h2>
                            Mọi thông tin bạn mong muốn đã hiển thị thành công trên màn hình điện thoại!
